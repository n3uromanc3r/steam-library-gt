...
class SteamLibraryGT
{
	...
	public function load_javascript(){
		...
		wp_localize_script('steam', 'steam_data', array( 'plugin_url' => plugins_url(), 'steam_web_api_key' => $this->steam_config['steam_web_api_key'], 'steam_profile_id' => $this->steam_config['steam_profile_id'], 'cache_exists' => file_exists(__DIR__ . '/../cache/.cached') ) );
